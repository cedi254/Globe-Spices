...
export default function Hero(){
 return <section className="still-hero" aria-labelledby="hero-title">
  <div className="still-hero-heading"><img className="hero-botanical" src="/images/hero-botanical.webp" alt="" width="153" height="408"/><p className="eyebrow">DIE WORLD COLLECTION</p><h1 id="hero-title">Vier Länder.<br/>Vier Gewürze.<br/><span>Eine Reise.</span></h1><p className="still-hero-description">Vier Gewürzmischungen aus Zürich – inspiriert von Orten, Menschen und Lieblingsgerichten.</p></div>
  ...
  <div className="still-hero-action"><a className="button" href="#kollektion">Kollektion entdecken <ArrowDown size={21}/></a><a className="still-scroll" href="#reise"><ArrowDown size={16}/><span>SCROLLEN & ENTDECKEN</span></a></div>
 </section>;
}
